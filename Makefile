...
#    Updated: 2024/09/04 15:25:03 by ksuh             ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
PRE_MEN_C = 2d_array_utils1.c close.c error.c ft_atod.c init.c key_handle.c main.c parse.c \
			parse_element.c parse_figure.c parse_utils.c
